#!/usr/bin/env python3
"""Собирает страницу источников книги про Toyota: по одному блоку на вопрос,
...
TOYOTA = Path('/Users/jexxx/autopapyrus-kdp/toyota')
OUT    = DEPLOY / 'books' / 'toyota' / 'sources' / 'index.html'

src    = json.load(io.open(TOYOTA / 'sources.json', encoding='utf-8'))
report = json.load(io.open(TOYOTA / 'toyota-trivia-v1-en.factcheck.json', encoding='utf-8'))
...
<title>Sources — Ultimate Toyota Challenge — Jan Walker</title>
<link rel="icon" href="/favicon.ico?v=2" sizes="any">
<link rel="apple-touch-icon" href="/apple-touch-icon.png?v=2">
<meta name="description" content="Every one of the ninety questions in Ultimate Toyota Challenge, with the source that settles it. Company filings, regulators, museums and independent tests — with the corrections made in review listed openly.">
<link rel="canonical" href="https://janwalkerbooks.com/books/toyota/sources/">
<meta name="robots" content="noindex,nofollow">
<meta name="googlebot" content="noindex,nofollow">
<meta property="og:type" content="article">
<meta property="og:site_name" content="Jan Walker Books">
<meta property="og:title" content="Sources — Ultimate Toyota Challenge">
<meta property="og:description" content="All ninety questions, each with the source that settles it.">
<meta property="og:url" content="https://janwalkerbooks.com/books/toyota/sources/">
{FONT_LINK}
<style>
{FONTS}
...
<h1>Ultimate Toyota Challenge</h1>
<hr class="rule">
...
<p class="sub">Found by checking every question one at a time, question by question rather than
part by part. These claims did not survive that check in their first form. Listed here rather
than quietly fixed.</p>
<div class="card"><ul>
{revs}
</ul></div>
